...
import com.afsan.ideaconnect_android.Adapter.NotificationAdapter;
...
public class Notification extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView  = view.findViewById(R.id.notification_viewer);

        notificationList = new ArrayList<>();
        notificationList.add(new NotificationModel(R.drawable.ic_profile,"Imtiaz Bhuiyan","Has Upvoted Your Idea","5:44 PM"));
        notificationList.add(new NotificationModel(R.drawable.ic_profile,"Imtiaz Bhuiyan","Has Upvoted Your Idea","5:44 PM"));
        notificationList.add(new NotificationModel(R.drawable.ic_profile,"Imtiaz Bhuiyan","Has Upvoted Your Idea","5:44 PM"));
        notificationList.add(new NotificationModel(R.drawable.ic_profile,"Imtiaz Bhuiyan","Has Upvoted Your Idea","5:44 PM"));
        notificationList.add(new NotificationModel(R.drawable.ic_profile,"Imtiaz Bhuiyan","Has Upvoted Your Idea","5:44 PM"));
